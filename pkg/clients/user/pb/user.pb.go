...
var file_user_proto_depIdxs = []int32{
	...
	2, // 2: pb.UserService.UnblockUser:input_type -> pb.ID
	1, // 3: pb.UserService.BlockUser:output_type -> pb.Response
	1, // 4: pb.UserService.UnblockUser:output_type -> pb.Response
